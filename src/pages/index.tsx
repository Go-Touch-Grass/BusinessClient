...
function AboutPage() {
  return (
    <section className='flex flex-col items-center justify-center min-h-screen bg-blue-50 p-6'>
      <div className='mb-6'>
      </div>
      ...
      <p className='mt-6 text-lg tracking-wide leading-8 max-w-2xl text-center text-blue-800'>
      ...
      <div className='mt-6 max-w-3xl mx-auto text-center'>
        <h2 className='text-2xl font-semibold mb-4 text-blue-900'>Why Join Us?</h2>
        <ul className='list-disc list-inside text-left text-blue-800'>
          <li className='mb-4'>
      ...
      <a
        ...
        className='mt-6 inline-block bg-blue-500 text-white py-3 px-6 rounded-lg font-semibold text-lg hover:bg-blue-600 transition-colors duration-300'
      >
        Join Us Now
      </a>
    </section>
